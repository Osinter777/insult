...
OSK_TEMPLATES = [
    ...
    "{} гнойный выкидыш из утробы героиновой шлюхи, твой отец сосёт в морге, уёбок"
]

# Шаблоны для /long (19-25 слов)
LONG_TEMPLATES = [
    ...
    "{} кончил в аппарат жизнеобеспечения твоей бабки, она сдохла, вся твоя семья гнойная куча в реанимации, сын нарковыбляди"
]
